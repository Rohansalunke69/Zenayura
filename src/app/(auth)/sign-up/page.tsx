...
export default function SignUp() {
    ...
    return (
        <div className="min-h-screen bg-[#F8FFF8] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <div className="flex justify-center">
                    <div className="bg-[#2E7D32] p-3 rounded-xl shadow-lg shadow-green-900/20">
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white py-8 px-4 shadow-xl shadow-green-900/5 sm:rounded-2xl sm:px-10 border border-green-50">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            <button
                                ...
                                className="w-full flex justify-center items-center py-2.5 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2E7D32] transition-colors"
                            >
